...
function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!testerCode.trim()) {
      setError('Tester code is required. The application is currently in development.');
      return;
    }
        ...
        >
          ...
          <div className="px-4 sm:px-6 md:px-8 py-6 sm:py-7 md:py-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 text-blue-800 px-4 py-3 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm">The application is currently in development. Registration is limited to testers only. If you don't have a tester code, please contact our support team via the Contact page to request one.</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className={`w-full pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 sm:py-3 text-sm sm:text-base border-2 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 bg-gray-50 focus:bg-white ${
              ...
              {/* Tester Code Field */}
              <div>
                <label htmlFor="testerCode" className="block text-xs sm:text-sm font-semibold text-gray-700 mb-2">
                  Tester Code <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                    <svg className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <input
                    id="testerCode"
                    type={showTesterCode ? 'text' : 'password'}
                    value={testerCode}
                  ...
                  <button
                    type="button"
                    onClick={() => setShowTesterCode(!showTesterCode)}
                    className="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center text-gray-400 hover:text-gray-600 transition-colors touch-manipulation"
                  >
                    {showTesterCode ? (
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-xs text-gray-500 mt-2 flex items-center">
                  ...
                  <span className="text-xs">Don't have a tester code? Contact our support team via the Contact page.</span>
                </p>
              </div>
